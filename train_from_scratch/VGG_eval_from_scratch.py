...
class_list, feature_matrix = pickle.load(open("/home/j0c023d/visual_search/miniImagenet/Train_results_scratch", "rb"))
...
with tf.Graph().as_default():
    ...
    logits, end_points = vgg.vgg_16(eval_image_batch, num_classes=class_number, is_training=False)
