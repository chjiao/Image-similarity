...
with tf.Graph().as_default():
    ...
    train_log_dir = './train_from_pretrain_2_checkpoints/'
    ...
    #init_fn = slim.assign_from_checkpoint_fn(os.path.join(checkpoints_dir, 'VGG_miniImagenet-19900.meta'), slim.get_model_variables('vgg_16'))
    ...
    train_step = tf.train.GradientDescentOptimizer(learning_rate=.0001).minimize(loss)
