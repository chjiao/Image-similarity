...
with tf.Graph().as_default():
    ...
    eval_image_batch, eval_label_batch = generate_image_and_label_batch(eval_image, eval_label, 2, batch_size,True)
    ...
    # test
    logits, end_points = vgg.vgg_16(eval_image_batch)
    ...
    predict_labels = tf.argmax(probabilities, axis=1)
    real_labels = tf.argmax(eval_label_batch, axis=1)
